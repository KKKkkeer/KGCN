...
parser.add_argument('--batch_size_kg', type=int, default=16384, help='KG batch size')
'''
'''
# book
...
parser.add_argument('--l2_weight', type=float, default=3e-5, help='weight of l2 regularization')
...
data = load_data(args)
train(args, data, show_loss, show_topk, train_Rec, train_KGE)
